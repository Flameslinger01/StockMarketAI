...
class PPOAgent(object):
    ...
    def _step(self, action: float):
        ...
        done = np.reshape(done or truncated, (1, -1))
    ...
    def train(self):
        ...
        for step_ in range(self.total_rollouts):
            ...
            if (step_ % self.plot_interval == 0):
                print("Difference: " + str(self.env.stockWorth + self.env.currentMoney - self.env.startingMoney) + "Current: " + str(self.env.stockWorth))
